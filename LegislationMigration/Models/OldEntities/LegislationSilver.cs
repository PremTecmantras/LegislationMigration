...
public partial class LegislationSilver
{
    ...
    public virtual ICollection<FailedAmendedLegislationsSilver> FailedAmendedLegislationsSilvers { get; set; } = new List<FailedAmendedLegislationsSilver>();

    public virtual ICollection<FailedLegislationRelationsSilver> FailedLegislationRelationsSilvers { get; set; } = new List<FailedLegislationRelationsSilver>();
