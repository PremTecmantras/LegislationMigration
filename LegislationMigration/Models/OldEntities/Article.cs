...
public partial class Article
{
    ...
    public virtual ICollection<AmendedLegislationsSilver> AmendedLegislationsSilverModifiedArticles { get; set; } = new List<AmendedLegislationsSilver>();

    public virtual ICollection<AmendedLegislationsSilver> AmendedLegislationsSilverOriginalArticles { get; set; } = new List<AmendedLegislationsSilver>();
