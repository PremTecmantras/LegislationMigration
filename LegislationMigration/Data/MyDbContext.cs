...
public partial class MyDbContext : DbContext
{
    ...
    public virtual DbSet<ExtractionJob> ExtractionJobs { get; set; }

    public virtual DbSet<FailedAmendedLegislationsSilver> FailedAmendedLegislationsSilvers { get; set; }

    public virtual DbSet<FailedLegislationRelationsSilver> FailedLegislationRelationsSilvers { get; set; }
    ...
    public virtual DbSet<ViewLegislationDomain> ViewLegislationDomains { get; set; }

    public virtual DbSet<VwAmmendedLegislation> VwAmmendedLegislations { get; set; }

    public virtual DbSet<VwDlpArIssuingAuthority> VwDlpArIssuingAuthorities { get; set; }

    public virtual DbSet<VwDlpArabicCategory> VwDlpArabicCategories { get; set; }

    public virtual DbSet<VwDlpEnIssuingAuthority> VwDlpEnIssuingAuthorities { get; set; }

    public virtual DbSet<VwDlpEnglishCategory> VwDlpEnglishCategories { get; set; }

    public virtual DbSet<VwDomainArticleMapping> VwDomainArticleMappings { get; set; }

    public virtual DbSet<VwFedralMappingAr> VwFedralMappingArs { get; set; }

    public virtual DbSet<VwFedralMappingEn> VwFedralMappingEns { get; set; }

    public virtual DbSet<VwLegislationArticle> VwLegislationArticles { get; set; }

    public virtual DbSet<VwLegislationBase> VwLegislationBases { get; set; }

    public virtual DbSet<VwLegislationInfo> VwLegislationInfos { get; set; }

    public virtual DbSet<VwLegislationReference> VwLegislationReferences { get; set; }

    public virtual DbSet<VwLegislationRerferenceAmmendment> VwLegislationRerferenceAmmendments { get; set; }

    public virtual DbSet<VwLegislationsWithArticle> VwLegislationsWithArticles { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-OON0NBG\\SQLEXPRESS;Initial Catalog=TEC.Datalake.PreProduction;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AmendedLegislationsSilver>(entity =>
        {
            ...
            entity.HasOne(d => d.ModifiedArticle).WithMany(p => p.AmendedLegislationsSilverModifiedArticles)
                .HasForeignKey(d => d.ModifiedArticleId)
                .HasConstraintName("FK_AmendedLegislationsSilver_Articles");

            entity.HasOne(d => d.ModifiedLegislation).WithMany(p => p.AmendedLegislationsSilvers)
                .HasForeignKey(d => d.ModifiedLegislationId)
                .HasConstraintName("FK_AmendedLegislationsSilver_Legislations");

            entity.HasOne(d => d.OriginalArticle).WithMany(p => p.AmendedLegislationsSilverOriginalArticles)
                .HasForeignKey(d => d.OriginalArticleId)
                .HasConstraintName("FK_AmendedLegislationsSilver_Articles1");

            entity.HasOne(d => d.OriginalLegislation).WithMany(p => p.AmendedLegislationsSilvers)
                .HasForeignKey(d => d.OriginalLegislationId)
                .HasConstraintName("FK_AmendedLegislationsSilver_LegislationSilver");
        });
        ...
        modelBuilder.Entity<Article>(entity =>
        {
            ...
            entity.HasIndex(e => e.ArticleTitle, "IX_Article_Title");
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            ...
            entity.HasIndex(e => e.CategoryNameEn, "IX_Category_Name_En");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Conflict__3214EC27A28CCC0B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Conflict__3214EC2795B5A9D1");
        ...
        modelBuilder.Entity<DlparabicDatum>(entity =>
        {
            ...
            entity.Property(e => e.FoundLocally).HasDefaultValue(false);
        ...
        {
            entity.HasIndex(e => e.DomainName, "IX_Domains_Name");
        ...
        {
            entity.HasIndex(e => new { e.DomainName, e.LanguageId }, "NonClusteredIndex-20250701-083721");

            entity.HasIndex(e => e.DomainName, "NonClusteredIndex-20250701-083741");
        ...
        modelBuilder.Entity<DraftLegislation>(entity =>
        {
            ...
            entity.Property(e => e.DraftLegislationId).HasColumnName("Draft_Legislation_Id");
            entity.Property(e => e.CategoryId).HasColumnName("Category_Id");
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime")
        ...
        modelBuilder.Entity<DraftStatusType>(entity =>
        {
            ...
            entity.HasIndex(e => e.StatusNameEn, "UQ_DraftStatusTypes").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_ErrorInfo");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__extracti__6E32B6A586AEC51F");
        ...
        modelBuilder.Entity<FailedAmendedLegislationsSilver>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK_FailedAmendedLegislations");

            entity.ToTable("FailedAmendedLegislationsSilver");

            entity.Property(e => e.Action).HasMaxLength(255);
            entity.Property(e => e.LegislationId).HasColumnName("Legislation_Id");

            entity.HasOne(d => d.Legislation).WithMany(p => p.FailedAmendedLegislationsSilvers)
                .HasForeignKey(d => d.LegislationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FailedAmendedLegislations_LegislationSilver");
        });

        modelBuilder.Entity<FailedLegislationRelationsSilver>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK_FailedLegislationRelations");

            entity.ToTable("FailedLegislationRelationsSilver");

            entity.Property(e => e.LegislationId).HasColumnName("Legislation_Id");
            entity.Property(e => e.RelationType).HasMaxLength(255);

            entity.HasOne(d => d.Legislation).WithMany(p => p.FailedLegislationRelationsSilvers)
                .HasForeignKey(d => d.LegislationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<FederalMetaArabicOld>(entity =>
        {
            ...
            entity.Property(e => e.DownloadUrl)
                .HasMaxLength(105)
                .IsUnicode(false)
                .HasComputedColumnSql("(('https://uaelegislation.gov.ae/ar/legislations/'+CONVERT([varchar](50),[number]))+'/download')", false);
            entity.Property(e => e.EffectiveDate)
                .HasMaxLength(50)
                .HasColumnName("effective_date");
            entity.Property(e => e.GeneratedFileName)
                .HasMaxLength(57)
                .IsUnicode(false)
                .HasComputedColumnSql("(CONVERT([varchar](50),[number])+'-ar.pdf')", false);
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Identifier).HasMaxLength(650);
            entity.Property(e => e.IssuedDate)
                .HasMaxLength(50)
        ...
        modelBuilder.Entity<FederalMetaEnglishOld>(entity =>
        {
            ...
            entity.Property(e => e.DownloadUrl)
                .HasMaxLength(105)
                .IsUnicode(false)
                .HasComputedColumnSql("(('https://uaelegislation.gov.ae/en/legislations/'+CONVERT([varchar](50),[number]))+'/download')", false);
            entity.Property(e => e.EffectiveDate).HasColumnName("effective_date");
            entity.Property(e => e.GeneratedFileName)
                .HasMaxLength(57)
                .IsUnicode(false)
                .HasComputedColumnSql("(CONVERT([varchar](50),[number])+'-en.pdf')", false);
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Identifier).HasMaxLength(750);
            entity.Property(e => e.IssuedDate).HasColumnName("issued_date");
            entity.Property(e => e.Language)
        ...
        {
            entity.HasKey(e => e.LanguageId).HasName("PK__Language__B7596FF3DB72A1AF");

            entity.HasIndex(e => e.LanguageNameEn, "IX_Language_Name_En");
        ...
        {
            entity.HasIndex(e => e.Title, "IX_Legislation_Title");

            entity.HasIndex(e => e.SourceFileName, "IX_Source_File_Name");
        ...
        modelBuilder.Entity<LegislationStatusType>(entity =>
        {
            ...
            entity.HasIndex(e => e.StatusNameEn, "IX_Status_Name");
        ...
        modelBuilder.Entity<LegislationsDataSourceRefTable>(entity =>
        {
            ...
            entity.Property(e => e.Imported).HasDefaultValue(true);
        ...
        modelBuilder.Entity<ReferencedLegislation>(entity =>
        {
            ...
            entity.HasIndex(e => e.ReferencedLegislationTitle, "IX_ReferencedLegislations_ReferencedLegislationTitle");
        ...
        modelBuilder.Entity<ReferencedLegislationsSilver>(entity =>
        {
            ...
            entity.HasOne(d => d.Legislation).WithMany(p => p.ReferencedLegislationsSilvers)
                .HasForeignKey(d => d.LegislationId)
                .HasConstraintName("FK_RefLegSilver_LegislationSilver");

            entity.HasOne(d => d.ReferencedLegislation).WithMany(p => p.ReferencedLegislationsSilvers)
                .HasForeignKey(d => d.ReferencedLegislationId)
                .HasConstraintName("FK_RefLegSilver_Legislations");
        ...
        modelBuilder.Entity<Source>(entity =>
        {
            ...
            entity.HasIndex(e => e.NameEn, "IX_Source_Name");
        ...
        modelBuilder.Entity<SubCategory>(entity =>
        {
            ...
            entity.HasIndex(e => e.CategoryNameEn, "IX_SubCategory_Name_En");
        ...
        modelBuilder.Entity<ViewLegislationDomain>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("View_Legislation_Domains");
            ...
            entity.Property(e => e.LanguageNameEn)
                ...
                .HasColumnName("Language_Name_En");
            entity.Property(e => e.LegislationId).HasColumnName("Legislation_Id");
            entity.Property(e => e.LegislationTypeAr)
                .HasMaxLength(150)
                .HasColumnName("Legislation_Type_Ar");
            entity.Property(e => e.LegislationTypeEn)
                .HasMaxLength(150)
                .HasColumnName("Legislation_Type_En");
            entity.Property(e => e.LegislationTypeId).HasColumnName("Legislation_Type_Id");
            entity.Property(e => e.ModifiedAt)
                .HasColumnType("datetime")
                .HasColumnName("Modified_at");
            ...
            entity.Property(e => e.SourceFileName)
                ...
                .HasColumnName("Source_File_Name");
            entity.Property(e => e.SourceId).HasColumnName("Source_Id");
            entity.Property(e => e.SourceNameAr)
                .HasMaxLength(50)
                .HasColumnName("Source_Name_Ar");
            entity.Property(e => e.SourceNameEn)
                .HasMaxLength(50)
                .HasColumnName("Source_Name_En");
            entity.Property(e => e.StatusId).HasColumnName("Status_Id");
            entity.Property(e => e.StatusNameAr)
                .HasMaxLength(250)
                .HasColumnName("Status_Name_Ar");
            entity.Property(e => e.StatusNameArabic)
                .HasMaxLength(250)
                .HasColumnName("Status_Name_Arabic");
            entity.Property(e => e.StatusNameEn)
                .HasMaxLength(250)
                .HasColumnName("Status_Name_En");
            entity.Property(e => e.SubCategoryId).HasColumnName("Sub_Category_Id");
            entity.Property(e => e.SubCategoryNameAr)
                .HasMaxLength(250)
                .HasColumnName("Sub_Category_Name_Ar");
            entity.Property(e => e.SubCategoryNameEn)
                .HasMaxLength(250)
                .HasColumnName("Sub_Category_Name_En");
            entity.Property(e => e.Title).HasMaxLength(500);
        });

        modelBuilder.Entity<VwAmmendedLegislation>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_AmmendedLegislations");
            ...
            entity.Property(e => e.LegislationId).HasColumnName("Legislation_Id");
            entity.Property(e => e.LegislationTypeId).HasColumnName("Legislation_Type_Id");
            entity.Property(e => e.LegislationTypeNameAr)
                .HasMaxLength(150)
                .HasColumnName("LegislationTypeName_Ar");
            entity.Property(e => e.LegislationTypeNameEn)
                .HasMaxLength(150)
                .HasColumnName("LegislationTypeName_En");
            entity.Property(e => e.ModifiedArticleBody).HasColumnName("Modified_Article_Body");
            entity.Property(e => e.ModifiedArticleTitle)
                .HasMaxLength(255)
                .HasColumnName("Modified_Article_Title");
            entity.Property(e => e.NameAr)
                .HasMaxLength(250)
                .HasColumnName("Name_Ar");
            entity.Property(e => e.NameEn)
            ...
            entity.Property(e => e.OfficialGazetteNumber)
                .HasMaxLength(250)
                .HasColumnName("Official_Gazette_Number");
            entity.Property(e => e.OriginalArticleBody).HasColumnName("Original_Article_Body");
            entity.Property(e => e.OriginalArticleNumber)
                .HasMaxLength(10)
                .IsFixedLength()
                .HasColumnName("Original_Article_Number");
            entity.Property(e => e.OriginalArticleTitle)
                .HasMaxLength(255)
                .HasColumnName("Original_Article_Title");
            entity.Property(e => e.OriginalLegislationTitle)
                .HasMaxLength(1500)
                .HasColumnName("Original_Legislation_Title");
            entity.Property(e => e.PdfUrl)
            ...
            entity.Property(e => e.SourceNameAr)
                .HasMaxLength(50)
                .HasColumnName("SourceName_Ar");
            entity.Property(e => e.SourceNameEn)
                .HasMaxLength(50)
                .HasColumnName("SourceName_En");
            entity.Property(e => e.StatusId).HasColumnName("Status_Id");
            entity.Property(e => e.StatusNameAr)
                .HasMaxLength(250)
                .HasColumnName("Status_Name_Ar");
        ...
        modelBuilder.Entity<VwDlpArIssuingAuthority>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_DLP_AR_Issuing_Authority");
        ...
        modelBuilder.Entity<VwDlpArabicCategory>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_DLP_Arabic_Categories");
        ...
        modelBuilder.Entity<VwDlpEnIssuingAuthority>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_DLP_EN_Issuing_Authority");
        ...
        modelBuilder.Entity<VwDlpEnglishCategory>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_DLP_English_Categories");
        ...
        modelBuilder.Entity<VwDomainArticleMapping>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_DomainArticleMapping");

            entity.Property(e => e.ArticleId).HasColumnName("Article_Id");
            entity.Property(e => e.DomainArticleId).HasColumnName("DomainArticle_Id");
            entity.Property(e => e.DomainTypeId).HasColumnName("Domain_Type_Id");
            entity.Property(e => e.DomainTypeName).HasMaxLength(550);
            entity.Property(e => e.LanguageId).HasColumnName("Language_Id");
            entity.Property(e => e.Rationale).HasMaxLength(1500);
        });

        modelBuilder.Entity<VwFedralMappingAr>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_FedralMapping_AR");
            ...
            entity.Property(e => e.EffectiveDate)
                .HasMaxLength(50)
                .HasColumnName("effective_date");
            entity.Property(e => e.FedralId).HasColumnName("Fedral_ID");
            entity.Property(e => e.GeneratedFileName)
                .HasMaxLength(57)
                .IsUnicode(false);
            entity.Property(e => e.Identifier).HasMaxLength(650);
            ...
            entity.Property(e => e.StatusId).HasColumnName("Status_Id");
            entity.Property(e => e.Title).HasMaxLength(500);
            entity.Property(e => e.TitleMeta)
                .HasMaxLength(200)
                .HasColumnName("Title_Meta");
            entity.Property(e => e.Year).HasColumnName("year");
        });

        modelBuilder.Entity<VwFedralMappingEn>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_FedralMapping_EN");
        ...
        modelBuilder.Entity<VwLegislationArticle>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_LegislationArticles");
        ...
        modelBuilder.Entity<VwLegislationBase>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_Legislation_Base");
        ...
        modelBuilder.Entity<VwLegislationInfo>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_LegislationInfo");

            entity.Property(e => e.AppendixContent).HasColumnName("Appendix_Content");
            entity.Property(e => e.ArticleBody).HasColumnName("Article_Body");
            entity.Property(e => e.ArticleId).HasColumnName("Article_Id");
            entity.Property(e => e.ArticleNumber).HasColumnName("Article_Number");
            entity.Property(e => e.ArticleTitle)
            ...
            entity.Property(e => e.CategoryNameArabic)
                .HasMaxLength(250)
                .HasColumnName("Category_Name_Arabic");
            entity.Property(e => e.DateOfIssuance)
                .HasColumnType("datetime")
                .HasColumnName("Date_Of_Issuance");
            entity.Property(e => e.LanguageNameEn)
                ...
                .HasColumnName("Language_Name_En");
            entity.Property(e => e.LegislationId).HasColumnName("Legislation_Id");
            entity.Property(e => e.LegislationTitle)
                .HasMaxLength(500)
                .HasColumnName("Legislation_Title");
            entity.Property(e => e.LegislationTypeNameAr)
                .HasMaxLength(150)
                .HasColumnName("Legislation_Type_Name_Ar");
            entity.Property(e => e.LegislationTypeNameEn)
                .HasMaxLength(150)
                .HasColumnName("Legislation_Type_Name_En");
            entity.Property(e => e.OfficialGazetteNumber)
                .HasMaxLength(250)
                .HasColumnName("Official_Gazette_Number");
            entity.Property(e => e.SourceFileName)
        ...
        modelBuilder.Entity<VwLegislationReference>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_LegislationReference");
            ...
            entity.Property(e => e.LegislationTypeAr)
                .HasMaxLength(150)
                .HasColumnName("LegislationType_Ar");
            entity.Property(e => e.LegislationTypeEn)
                .HasMaxLength(150)
                .HasColumnName("LegislationType_En");
            entity.Property(e => e.LegislationTypeId).HasColumnName("Legislation_Type_Id");
            entity.Property(e => e.ModifiedAt)
                .HasColumnType("datetime")
                .HasColumnName("Modified_at");
            ...
            entity.Property(e => e.StatusId).HasColumnName("Status_Id");
            entity.Property(e => e.SubCategoryId).HasColumnName("Sub_Category_Id");
            entity.Property(e => e.SubCategoryName).HasMaxLength(250);
            entity.Property(e => e.Title).HasMaxLength(500);
        });

        modelBuilder.Entity<VwLegislationRerferenceAmmendment>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_Legislation_Rerference_Ammendments");
            ...
            entity.Property(e => e.AmendmentText)
                .HasMaxLength(2500)
                .HasColumnName("Amendment_Text");
            entity.Property(e => e.AmmendmentId).HasColumnName("Ammendment_ID");
            entity.Property(e => e.ArticleBody).HasColumnName("Article_Body");
            entity.Property(e => e.ArticleId).HasColumnName("Article_Id");
            entity.Property(e => e.ArticleNumber).HasColumnName("Article_Number");
            entity.Property(e => e.ArticleTitle)
            ...
            entity.Property(e => e.LegislationTypeEn)
                ...
                .HasColumnName("Legislation_Type_En");
            entity.Property(e => e.LegislationTypeId).HasColumnName("Legislation_Type_Id");
            entity.Property(e => e.ModifiedArticleNumber)
                .HasMaxLength(10)
                .IsFixedLength()
                .HasColumnName("Modified_Article_Number");
            entity.Property(e => e.ModifiedAt)
                .HasColumnType("datetime")
                .HasColumnName("Modified_at");
            entity.Property(e => e.ModifiedBy)
        ...
        modelBuilder.Entity<VwLegislationsWithArticle>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VW_LegislationsWithArticles");
